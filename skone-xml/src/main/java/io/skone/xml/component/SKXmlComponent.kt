 ...
 */
public abstract class SKXmlComponent @JvmOverloads constructor(
    context: Context,
    ...
    protected fun applyLayoutSpec(spec: SKLayoutSpec) {
        ...
        lp.height = when (spec.height.mode) {
            SKLayoutMode.Wrap -> LayoutParams.WRAP_CONTENT
            SKLayoutMode.Fill -> LayoutParams.MATCH_PARENT
 ...
 */
public open class SKXmlComponentHost @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
