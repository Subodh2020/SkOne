 ...
 */
public class SKTextFieldView @JvmOverloads constructor(
    context: Context,
    ...
    private fun applyAttributes(attrs: AttributeSet) {
        ...
        try {
            ...
            imeAction = when (a.getInt(R.styleable.SKTextFieldView_skImeAction, 0)) {
                1 -> SKImeAction.Done
                2 -> SKImeAction.Go
                3 -> SKImeAction.Next
            ...
            keyboardType = when (a.getInt(R.styleable.SKTextFieldView_skKeyboardType, 0)) {
    ...
    private fun render() {
        ...
        if (showLabel) {
            ...
            val labelColor = if (fieldComponent.visualState == SKFieldVisualState.Error) {
                SKColorRole.Error
            } else {
        ...
        if (showSupport) {
            ...
            val supportColor = when (fieldComponent.visualState) {
    ...
    private fun applyChrome() {
        ...
        val stroke = if (editText.hasFocus()) {
    ...
    private fun SKImeAction.toEditorAction(): Int = when (this) {
