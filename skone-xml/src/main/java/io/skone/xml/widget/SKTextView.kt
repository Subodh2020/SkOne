    ...
    constructor(
        ...
        private fun applyAttributes(attrs: AttributeSet) {
            ...
            try {
                ...
                overflow =
                    when (a.getInt(R.styleable.SKTextView_skOverflow, 0)) {
                        1 -> SKTextOverflow.Ellipsis
                        2 -> SKTextOverflow.Visible
                        else -> SKTextOverflow.Clip
                    }
                textAlign =
                    when (a.getInt(R.styleable.SKTextView_skTextAlign, 0)) {
        ...
        private fun typefaceStyle(weight: Int): Int =
            when {
        ...
        private fun typographyRoleFromAttr(value: Int): SKTypographyRole =
            when (value) {
        ...
        private fun contentColorRoleFromAttr(value: Int): SKColorRole =
            when (value) {
